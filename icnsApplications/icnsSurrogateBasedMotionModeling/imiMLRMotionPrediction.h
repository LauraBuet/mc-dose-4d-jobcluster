/** \file imiMLRMotionPredictionMethods.h
 *
...
class imiMLRMotionPrediction: public imiObject
{

public:

  /* Class macro needed because class inherits from imiObject. */
  imiClassMacro(imiMLRMotionPrediction,imiObject)
  ;

  /** Create an instance of the object, use Delete() to destroy. */
  static imiMLRMotionPrediction* New();
...
protected:
  ...
  /** \brief Constructor */
  imiMLRMotionPrediction();

  /** \brief Destructor */
  virtual ~imiMLRMotionPrediction();
